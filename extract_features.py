...
def read_example_sentences(data_dir, input_file, num_examples):
    data_df = pd.read_csv(os.path.join(data_dir, input_file), nrows=num_examples)
    examples = []
    print(data_df.head())
    # unique_id = 0
...
def main(_):
    ...
    examples = read_example_sentences(FLAGS.data_dir, FLAGS.input_file, FLAGS.num_examples)
